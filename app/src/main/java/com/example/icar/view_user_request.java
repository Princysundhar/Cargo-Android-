...
public class view_user_request extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = sh.getString("url","") + "android_view_user_request";
...
//
                                ...
                                li.setAdapter(new custom_view_user_request(getApplicationContext(),req_id,date,status,latitude,longitude,no_of_request));
